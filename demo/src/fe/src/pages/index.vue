      ...
      <el-main>
        ...
        <el-form :inline="true" >
          <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item>热门书籍</el-breadcrumb-item>
          </el-breadcrumb>
        </el-form>
            ...
            <el-row>
              <el-col :span="6">
                <el-form-item label="书籍名称：" prop="bookName">
                  <el-input v-model="form.bookName"   clearable placeholder="请输入书籍名称"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="6">
                <el-form-item label="书籍编码：" prop="bookNbr">
                  <el-input v-model="form.bookNbr"   clearable placeholder="请输入书籍编码"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="6">
                <el-form-item>
          ...
          <el-table :data="tableData" v-loading="loading" style="width: 100%;" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="bookId" label="书籍标识"></el-table-column>
            <el-table-column prop="bookName" label="书籍名称"></el-table-column>
            <el-table-column prop="bookNbr" label="书籍编码"></el-table-column>
